...
_ws.vm = new _intv_VoiceModule(_ws, 'ID2400_LotNumberAlphaNum');




_ws.vm.addInitialPromptGroup();
  _ws.vm.addInitialPrompt('ID2400_i_1');  /* Please say the lot number for the calibration information. */
_ws.vm.addNomatchPromptGroup('1', 'sequence', false);
  _ws.vm.addNomatchPrompt('Global_r_1');  /* I'm sorry. */
  _ws.vm.addNomatchPrompt('ID2400_r_1');  /* Please say the lot number, one character at a time. */
_ws.vm.addNoinputPromptGroup('1', 'sequence', false);
  _ws.vm.addNoinputPrompt('Global_r_1');  /* I'm sorry. */
  _ws.vm.addNoinputPrompt('ID2400_r_1');  /* Please say the lot number, one character at a time. */
_ws.vm.addDisconfirmPromptGroup('1', 'sequence', false);
  _ws.vm.addDisconfirmPrompt('Global_r_1');  /* I'm sorry. */
  _ws.vm.addDisconfirmPrompt('ID2400_r_1');  /* Please say the lot number, one character at a time. */
{
  var promptArray = [];
  var promptCounter = 0;
  promptArray[promptCounter++] = [ 'ID2400_c_1', 'messageid' ];  /* That was... */
  {
    var f = _ws.gateKeeper._getDataFormat("lotnumber");
    promptArray[promptCounter++] = [ '<Result>', f ];
  }
  promptArray[promptCounter++] = [ 'ID2400_c_2', 'messageid' ];  /* Is that right?  Yes or no? */
...
_ws.vm.setGrammar('ID2400_LotNumberAlphaNum.grxml', 'voice');
